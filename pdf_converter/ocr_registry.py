...
# koga ke napravime register_model ova se pravi vo pozadina:
# EasyOCRModel = register_model("easyocr", "EasyOCR")(EasyOCRModel)
# ova register_model("easyocr", "EasyOCR") ja vrakja funkcijata decorator(cls) i vo cls vlaga novata klasa primer EasyOCRModel
# vo decoratorot se proveruva neso i plus se pravi funkcija facotry koja samo vrakja EasyOCRModel()
# i plus na funkcijata i se stava atribut koj e labelata. Moze na funkcii da se stava atributi
...
def register_model(key: str, label: str):
    ...
    """
    # register model ja vrakja ovaa funkcija decorator()
